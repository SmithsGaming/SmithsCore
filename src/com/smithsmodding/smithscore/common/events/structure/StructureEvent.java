...
public class StructureEvent extends NBTNetworkableEvent {
    ...
    protected void readSyncCompound(NBTTagCompound compound) {
        ...
        try {
            structure = StructureRegistry.getInstance().constructStructure(compound.getString(CoreReferences.NBT.StructureData.TYPE), compound.getCompoundTag(CoreReferences.NBT.StructureData.STRUCTURE));
