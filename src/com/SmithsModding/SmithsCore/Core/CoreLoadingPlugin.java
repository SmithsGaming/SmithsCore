...
public class CoreLoadingPlugin implements IFMLLoadingPlugin {
    ...
    public String[] getASMTransformerClass () {
        return new String[]{RenderDurabilityBarOverlayTransformer.class.getName()};
    }
     ...
     * additional setup this coremod may require. It will be run <strong>prior</strong> to Minecraft starting, so it
     * CANNOT operate on minecraft itself. The game will deliberately crash if this code is detected to trigger a
